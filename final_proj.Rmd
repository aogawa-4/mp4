...
author: "Aoi Ogawa and Ester Zhao"
date: "4/30/2018"
...
ggplot(data_sum, aes(x = rating_info, y = sum_gross, color = oscar)) + 
  ...
  scale_color_discrete(name = "Type of Film", breaks = c("FALSE", "TRUE"), labels = c("High Grossing Film", "Oscar Nominated Film")) +
...
```{r, message = FALSE, warning = FALSE, echo= FALSE, fig.width = 15, fig.height =10}
...
data_all <- bind_rows(all_oscar, all_film)
 ...
 ggplot(data_all) + 
  ...
  scale_x_discrete(breaks = c("Action", "Adventure", "Animation", "Biography", "Comedy", "Crime", "Drama", "Family", "Fantasy", "History", "Music", "Musical", "Mystery", "Romance", "Sci-Fi", "Sport", "Thriller", "War", "Western"), labels = c("ACT", "ADV", "ANM", "BIO", "COM", "CRM", "DRM", "FAM", "FAN", "HIS", "MUS", "MUC", "MYS", "ROM", "SCI", "SPT", "THR", "WAR", "WES")) +
   theme(plot.title = element_text(size = 20), axis.title = element_text(size = 15))

```

#### Codes for Each Abbreviation 

ACT = Action,   CRM = Crime,   MUS = Music,   SPT = Sport

ADV = Adventure,   DRM = Drama,   MUC = Musical,   THR = Thriller

ANM = Animation,   FAM = Family,   MYS = Mystery,   WAR = War  

BIO = Biology,   FAN = Fantasy,   ROM = Romance,   WES = Western

COM = Comedy,   HIS = History,   SCI = Sci-Fi
