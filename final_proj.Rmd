...
The demographic of the voting body is the majority of the problem. In 2014, an article by the Los Angeles Times stated that the average Academy voter was a 63-year-old white man (http://graphics.latimes.com/oscars-2016-voters/ [^1]). Below is a graphic taken from DataDrivenJournalism.net displaying the demographics of the Academy.

![] (http://datadrivenjournalism.net/uploads/Screen_shot_2012-03-07_at_9.31.32_AM.png) 

\n (http://datadrivenjournalism.net/featured_projects/inside_the_academy_l.a._times_investigates_the_demographics_of_oscars_voter [^2])
...
ggplot(all_film, aes(x = production_year, y = genre, color = genre_info)) + 
  geom_point() +
  geom_line() + 
  labs(title = "Top Gross Films: \n Genre Trends between 2007 to 2016", x = "Production Year", y = "Total Number") +
...
ggplot(data_all) + 
  ...
  labs(title = "The Number of Each Genre", x = "Genre", y = "Total Number" ) +
...
https://github.com/aogawa-4/mp4.git [^4]





[^1]: Source for article "Oscars 2016 voters"
[^2]: Source for article "Inside the Academy: L.A. Times investigates the demographics of Oscars' voters"
[^3]: Source for article "When Will Marvel Studios Win an Oscar?"
[^4]: Github link for our project
